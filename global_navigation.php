...
?>
<nav class="navbar navbar-expand-lg navbar-dark custom-navbar-bg sticky-top">
            ...
            <ul class="navbar-nav">
                <li class="nav-item me-3 position-relative">
                    <a class="nav-link custom-currency-link d-flex align-items-center" href="#">
                        <img class="currency_icon" src="../images/star_point_symbol.png"> <span class="currency-value star-points-value"><?php echo $star_points; ?></span>
                        <div class="currency-tooltip">Star Points</div>
                    </a>
                </li>
                <li class="nav-item position-relative">
                    <a class="nav-link custom-currency-link d-flex align-items-center" href="#">
                        <img class="currency_icon" src="../images/skill_point_symbol.png"> <span class="currency-value skill-points-value"><?php echo $skill_points; ?></span>
